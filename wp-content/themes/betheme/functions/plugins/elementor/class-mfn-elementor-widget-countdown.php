...
class Mfn_Elementor_Widget_Countdown extends \Elementor\Widget_Base {
  ...
  public function get_script_depends() {
		if ( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			wp_register_script( 'mfn-el-countdown', get_theme_file_uri( '/functions/plugins/elementor/assets/widget-countdown-preview.js' ), [ 'elementor-frontend' ], MFN_THEME_VERSION, true );
    ...
    $this->add_control(
		...
		$this->add_control(
			'number_size',
			[
				'label' => __( 'Number font size', 'mfn-opts' ),
