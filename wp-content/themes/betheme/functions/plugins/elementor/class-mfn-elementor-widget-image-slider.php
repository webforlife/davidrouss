...
class Mfn_Elementor_Widget_Collection extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Be • Collection', 'mfn-opts' );
	}
	...
	protected function render() {
		...
		echo sc_image_slider( $settings, $settings['content'] );
