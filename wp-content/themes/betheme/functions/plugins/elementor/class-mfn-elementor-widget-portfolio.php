  ...
  public function get_script_depends() {
    ...
    $this->add_control(
          ...
          6	=> 6,
				...
				'default' => 3,
        'condition' => [
          'style' => ['flat', 'grid', 'masonry', 'masonry-minimal', 'masonry-hover'],
        ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'description' => __( 'for category: all or multiple categories (only selected categories show in filters)', 'mfn-opts' ),
				'options'	=> array(
					0 => __('No', 'mfn-opts'),
					1 => __('Yes', 'mfn-opts'),
				),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Style', 'mfn-opts' ),
				'condition' => [
          'style' => ['masonry','masonry-hover','list','exposure'],
        ],
			]
		);
