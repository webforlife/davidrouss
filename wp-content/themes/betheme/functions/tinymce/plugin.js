    ...
    editor.addButton('mfnsc', {
      ...
      menu: [{
        ...
        menu: [{
          ...
          text: 'Icon Box',
          onclick: function() {
            editor.insertContent('[icon_box title="" title_tag="h4" icon="icon-lamp" image="" icon_position="" border="0" link="" target="_blank" class="" animate=""]Insert your content here[/icon_box]');
          }
        }, {
          text: 'Info Box',
          onclick: function() {
