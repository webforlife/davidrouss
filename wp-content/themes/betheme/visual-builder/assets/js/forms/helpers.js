...
const aliases = {
    ...
    'post_love': [
        ...
        { key: 'content', val: '' },
        { key: 'css_icon_box_icon_wrapper_width', val: '30px' },
        { key: 'css_icon_box_icon_wrapper_i_font_size', val: '25px' },
        { key: 'title_tag', val: 'p' }
    ],
    'post_author': [
        ...
        { key: 'css_icon_box_icon_wrapper_width', val: '48px' },
        { key: 'title_tag', val: 'p' }
    ],
    'post_date': [
        { key: 'title', val: '{date}' },
...
const rewrited_fields = {
    item: {
        'product_images': [ // added 20.05.2023
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-style',           new: 'css_image_border_style'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-color',           new: 'css_image_border_color'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-width',           new: 'css_image_border_width'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-width_tablet',    new: 'css_image_border_width_tablet'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-width_mobile',    new: 'css_image_border_width_mobile'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-radius',          new: 'css_image_border_radius'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-radius_tablet',   new: 'css_image_border_radius_tablet'},
            {old: 'style:.mcb-section .mcb-wrap .mcb-item-mfnuidelement .flex-viewport:border-radius_mobile',   new: 'css_image_border_radius_mobile'},
        ],
        'accordion': [
...
const additional_css = {
    ...
    'css_menu_li-submenulia_justify_content_laptop': { // header_burger justify content & text align
        new_id: 'css_menu_li-submenulia_text_align_laptop',
        path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement .mfn-header-tmpl-menu-sidebar .mfn-header-menu li .mfn-submenu li a',
        style: 'text-align',
        rewrites: {
            'flex-start': 'left',
    ...
    'css_menu_li-submenulia_justify_content_tablet': { // header_burger justify content & text align
        new_id: 'css_menu_li-submenulia_text_align_tablet',
        path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement .mfn-header-tmpl-menu-sidebar .mfn-header-menu li .mfn-submenu li a',
        style: 'text-align',
        rewrites: {
            'flex-start': 'left',
    ...
    'css_menu_li-submenulia_justify_content_mobile': { // header_burger justify content & text align
        new_id: 'css_menu_li-submenulia_text_align_mobile',
        path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement .mfn-header-tmpl-menu-sidebar .mfn-header-menu li .mfn-submenu li a',
        style: 'text-align',
        rewrites: {
            'flex-start': 'left',
    ...
    'css_banner-box_text_align_laptop': { // banner box text align & align items
        new_id: 'css_banner_box_align_items_laptop',
        path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement .mfn-banner-box .banner-wrapper',
        style: 'align-items',
        rewrites: {
            'left': 'flex-start',
    ...
    'css_banner-box_text_align_tablet': { // banner box text align & align items
        new_id: 'css_banner_box_align_items_tablet',
        path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement .mfn-banner-box .banner-wrapper',
        style: 'align-items',
        rewrites: {
            'left': 'flex-start',
    ...
    'css_banner-box_text_align_mobile': { // banner box text align & align items
        new_id: 'css_banner_box_align_items_mobile',
        path: '.mcb-section .mcb-wrap .mcb-item-mfnuidelement .mfn-banner-box .banner-wrapper',
        style: 'align-items',
        rewrites: {
            'left': 'flex-start',
