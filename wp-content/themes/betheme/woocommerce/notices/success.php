...
<?php foreach ( $notices as $notice ) : ?>
	<div class="woocommerce-message alert alert_success"<?php echo wc_get_notice_data_attr( $notice ); ?> role="alert">
		<div class="alert_icon"><svg viewBox="0 0 28 28" aria-hidden="true"><g><polyline points="8.07 13 12.36 18.29 19.93 9.71" class="path"/><circle cx="14" cy="14" r="12" class="path"/></g></svg></div>
