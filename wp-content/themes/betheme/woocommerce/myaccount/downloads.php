...
<?php else : ?>
	...
	<div class="alert alert_info">
		...
		<div class="alert_wrapper"> <?php esc_html_e( 'No downloads available yet.', 'woocommerce' ); ?> <a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e( 'Browse products', 'woocommerce' ); ?></a></div>
	</div>
