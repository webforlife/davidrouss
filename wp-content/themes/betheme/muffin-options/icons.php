...
class Mfn_Icons {
	...
	public static function get_icons( $type = false ){
	...
	/**
	 * Check if string is an icon
	 */

	public static function is_icon( $search ){

		foreach (self::icons as $pack => $icons) {
			$key = array_search($search, $icons);
			if( $key !== false ){
				return $pack;
			}
   	}
	...
	public static function the_modal(){
		...
		echo '<div class="mfn-modal modal-select-icon">';
			echo '<div class="mfn-modalbox mfn-form mfn-shadow-1">';
				...
				echo '<div class="modalbox-header">';
					...
					echo '<div class="options-group">';
						echo '<div class="modalbox-title-group">';
							echo '<span class="modalbox-icon mfn-icon-add-big"></span>';
							echo '<div class="modalbox-desc">';
								echo '<h4 class="modalbox-title">'. __('Select an icon', 'mfn-opts') .'</h4>';
							echo '</div>';
						echo '</div>';
					echo '</div>';

					echo '<div class="options-group modalbox-search">';
						...
						echo '<div class="form-control">';
							echo '<select class="mfn-form-control mfn-form-select mfn-select">';
								echo '<option value="mfnicons">'. __('Default', 'mfn-opts') .'</option>';
								echo '<option value="fontawesome" '. $fa_disabled .'>'. __('Font Awesome', 'mfn-opts') .'</option>';
						...
						echo '<div class="form-control">';
							echo '<input class="mfn-form-control mfn-form-input mfn-search" type="text" placeholder="'. __('Search', 'mfn-opts') .'">';
						echo '</div>';

					echo '</div>';

					echo '<div class="options-group">';
						echo '<a class="mfn-option-btn mfn-option-blank btn-large btn-modal-close" href="#"><span class="mfn-icon mfn-icon-close"></span></a>';
					echo '</div>';
				...
				echo '<div class="modalbox-content">';
					...
					echo '<ul class="mfn-items-list mfnicons">';

						foreach( $icons['mfn'] as $icon ){

							$name = str_replace( 'icon-', '', $icon );
							echo '<li data-rel="'. esc_attr( $icon ) .'"><a href="#"><span class="mfn-icon"><i class="'. esc_attr( $icon ) .'"></i></span> <p>'. esc_attr( $name ) .'</p></a></li>';

						}

					echo '</ul>';

					echo '<ul class="mfn-items-list fontawesome">';
					...
					foreach( $custom_icon_bundle as $icon_pack ){
						...
						echo '<ul class="mfn-items-list '. preg_replace('[\W]', '', $icon_pack_name) .'">';
							...
							foreach( $icon_pack as $icon ){
								...
								// FIX | Multiple names
								// Icomoon divides icons by comma, get rid of rest of name when noticed

								$icon_single_name = preg_replace( '/,.*/', '', $icon );
								echo '<li data-rel="'. esc_attr( $icon_pack_prefix .'-'. $icon_single_name ) .'"><a href="#"><span class="mfn-icon"><i class="'. esc_attr( $icon_pack_prefix .'-'. $icon_single_name ) .'"></i></span> <p>'. esc_attr( $icon ) .'</p></a></li>';
